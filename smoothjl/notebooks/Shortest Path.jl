...
# ╔═╡ 908ae3a8-ae73-4991-9294-d8d5b4392ae4
using DelimitedFiles

# ╔═╡ a807d25b-b974-465a-85f6-4fa3e8dbe006
using Distances

# ╔═╡ c2ac61df-4e6a-40bb-8ee5-4608ff0ab97e
using TravelingSalesmanExact, GLPK

# ╔═╡ 1a6f1f3f-7baf-4832-a4ee-12553c7a7ef0
points = readdlm("points.txt", ' ', Float32, '\n')'[:, 1:50]

# ╔═╡ 0e6e5d1f-483a-4224-b202-689f8510c713
distances = pairwise(Euclidean(), points, dims=2)

# ╔═╡ 5a914dea-3ae5-4d4f-b117-a5516835716a
set_default_optimizer!(GLPK.Optimizer)

# ╔═╡ a6e918e7-d21d-4c55-b2b3-dc7007631782
...
deps = ["JuMP", "LinearAlgebra", "Logging", "MathOptInterface", "Printf", "UnicodePlots"]
git-tree-sha1 = "64525f2d63ac8687154894c6ef34c10a51a65a44"
